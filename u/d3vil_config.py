...
class Config(object):
    ...
    ALIVE_MSG = os.environ.get("ALIVE_MSG", "⚡ ℓεgεη∂αяү αғ ᴀɴɢᴇʟ  ⚡")
    ALIVE_PIC = os.environ.get("ALIVE_PIC", "https://te.legra.ph/file/5963540f94376ddf8d1f7.jpg")
    ...
    if AUTH_TOKEN_DATA != None:
        ...
        t_file.close()
    BIO_MSG = os.environ.get("BIO_MSG", "༆ʟᴇɢᴇɴᴅʀʏ ᴀғ ᴛᴇᴀᴍ ᴀɴɢᴇʟ༆")
    ...
    PMPERMIT_PIC = os.environ.get("PMPERMIT_PIC", "https://te.legra.ph/file/5963540f94376ddf8d1f7.jpg")
