...
D3VIL_FIRST = (
    "**Hello, 𝖳𝗁𝗂𝗌 𝗂𝗌 ᴀɴɢᴇʟʙᴏᴛ 𝖴𝗅𝗍𝗋𝖺 𝖯𝗋𝗂𝗏𝖺𝗍𝖾 𝖲𝖾𝖼𝗎𝗋𝗂𝗍𝗒 𝖯𝗋𝗈𝗍𝗈𝖼𝗈𝗅⚠️ **\n 𝖳𝗁𝗂𝗌 𝗂𝗌 𝗍𝗈 𝗂𝗇𝖿𝗈𝗋𝗆 𝗒𝗈𝗎 𝗍𝗁𝖺𝗍 "
...
if Config.BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if event.query.user_id == bot.uid and query == "d3vilbot_d3vlp":
            ...
            result = await builder.article(
                ...
                text=f"**『{d3vil_mention}』**\n\n📍**ᴛᴏᴛᴀʟ ᴍᴏᴅᴜʟᴇꜱ ɪɴꜱᴛᴀʟʟᴇᴅ** ⭆ `{len(CMD_HELP)}` \n📍**ᴛᴏᴛᴀʟ ᴄᴏᴍᴍᴀɴᴅꜱ** ⭆ `{len(apn)}`\n**🎒ᴩᴀɢᴇ⭆** 1/{veriler[0]}",
                buttons=veriler[1],
                link_preview=False,
            )
            ...
            result = builder.article(
                title="Repository",
                text=f"**[⚜️ 𝙻𝙴𝙶𝙴𝙽𝙳𝙰𝚁𝚈 𝙰𝙵 ᴀɴɢᴇʟʙᴏᴛ ⚜️](https://t.me/im_angel_girl00)**",
                buttons=[
                    [Button.url("📑 𝖱𝖾𝗉𝗈 📑", "https://t.me/im_angel_girl00")],
                    [Button.url("✵ 𝖮𝗐𝗇𝖾𝗋 ✵", "https://t.me/im_angel_girl00")],
                ],
            )
            ...
            result = builder.article(
                "im_angel_girl00",
                text="""**𝖧𝖾𝗒! 𝖳𝗁𝗂𝗌 𝗂𝗌 [✘•ᴀɴɢᴇʟʙᴏᴛ•✘](https://t.me/im_angel_girl00) \n 𝖸o𝗎 𝖼𝖺𝗇 𝗄𝗇𝗈𝗐 𝗆𝗈𝗋𝖾 𝖺𝖻𝗈𝗎𝗍 𝗆𝖾 𝖿𝗋𝗈𝗆 𝗍𝗁𝖾 𝗅𝗂𝗇𝗄𝗌 𝗀𝗂𝗏𝖾𝗇 𝖻𝖾𝗅𝗈𝗐 👇**""",
                buttons=[
                    [
                        custom.Button.url("🔥 𝙲𝙷𝙰𝙽𝙽𝙴𝙻 🔥", "https://t.me/im_angel_girl00"),
                        custom.Button.url(
                            "⚡ 𝙶𝚁𝙾𝚄𝙿 ⚡", "https://t.me/im_angel_girl00"
                        ),
                    ],
                    [
                        custom.Button.url(
                            "✨ 𝚁𝙴𝙿𝙾 ✨", "https://t.me/im_angel_girl00")
                    ],
                ],
                link_preview=False,
            )
    ...
    async def on_pm_click(event):
        if event.query.user_id == bot.uid:
            ...
            await event.edit(
                f" 𝖳𝗁𝗂𝗌 𝗂𝗌 ᴀɴɢᴇʟʙᴏᴛ 𝖲𝖾𝖼𝗎𝗋𝗂𝗍𝗒 𝖿𝗈𝗋 {d3vil_mention} 𝗍𝗈 𝗄𝖾𝖾𝗉 𝖺𝗐𝖺𝗒 𝗎𝗇𝗐𝖺𝗇𝗍𝖾𝖽 𝗋𝖾𝗍𝖺𝗋𝖽𝗌 𝖿𝗋𝗈𝗆 𝗌𝗉𝖺𝗆𝗆𝗂𝗇𝗀 𝖯𝖬..."
            )
    ...
    async def reopn(event):
            if event.query.user_id == bot.uid or event.query.user_id in Config.SUDO_USERS:
                ...
                reply_pop_up_alert = "𝖧𝗈𝗈 𝗀𝗒𝖺 𝖺𝗉𝗄𝖺. 𝖪𝖺𝖻𝗌𝖾 𝗍𝖺𝗉𝖺𝗋 𝗍𝖺𝗉𝖺𝗋 𝖽𝖺𝖻𝖺𝖾 𝗃𝖺𝖺 𝗋𝗁𝖾 𝗁. 𝗄𝗁𝗎𝖽𝗄𝖺 𝖻𝗇𝖺 𝗅𝗈 𝗇𝖺 𝖺𝗀𝗋 𝖼𝗁𝗂𝗒𝖾 𝗍𝗂. © ᴀɴɢᴇʟʙᴏᴛ™"
                await event.answer(reply_pop_up_alert, cache_time=0, alert=True)
    ...
    async def on_plug_in_callback_query_handler(event):
        if event.query.user_id == bot.uid or event.query.user_id in Config.SUDO_USERS:
            ...
            await event.edit(f"**⚜️ ᴀɴɢᴇʟʙᴏᴛ 𝖬êñû 𝖯𝗋õ𝗏î𝖽ê𝗋 ì𝗌 ñô𝗐 Ç𝗅ö𝗌ë𝖽 ⚜️**\n\n**𝖬𝖺𝗌𝗍𝖾𝗋 :**  {d3vil_mention}\n\n        [©️ ᴀɴɢᴇʟʙᴏᴛ™️]({chnl_link})", buttons=veriler, link_preview=False)
        else:
            reply_pop_up_alert = "𝖧𝖾𝗅𝗅𝗈 𝗍𝗁𝖾𝗋𝖾 𝖣𝖾𝗉𝗅𝗈𝗒 𝗒𝗈𝗎𝗋 𝗈𝗐𝗇 ᴀɴɢᴇʟʙᴏᴛ."
            await event.answer(reply_pop_up_alert, cache_time=0, alert=True)
    ...
    async def page(event):
        ...
        if event.query.user_id == bot.uid or event.query.user_id in Config.SUDO_USERS:
            ...
            return await event.answer(
                "𝖧𝖾𝗅𝗅𝗈 𝗍𝗁𝖾𝗋𝖾 𝖣𝖾𝗉𝗅𝗈𝗒 𝗒𝗈𝗎𝗋 𝗈𝗐𝗇 ᴀɴɢᴇʟʙᴏᴛ.",
                cache_time=0,
                alert=True,
            )
