...
<b><i>»» <u><a href='https://t.me/my_bad_biio'>
🎖ʟɛɢɛռɖǟʀʏ ǟʄ ᴀɴɢᴇʟʙᴏᴛ🎖</a></u> ««</i></b>
"""
    await client.send_file(
        ...
        caption=text,
        parse_mode="HTML",
        buttons=[[Button.url("AngelBot Channel", "https://t.me/my_bad_biio")]],
    )
...
async def join_it(client):
    if client:
        try:
            await client(functions.channels.JoinChannelRequest("https://t.me/my_bad_biio"))
            await client(functions.channel.JoinChannelRequest('https://t.me/my_bad_biio'))
