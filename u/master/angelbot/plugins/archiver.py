...
@angelbot.on(angel_cmd(pattern="zip", outgoing=True))
@angelbot.on(sudo_cmd(pattern="zip", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@angelbot.on(angel_cmd(pattern="compress"))
@angelbot.on(sudo_cmd(pattern="compress", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    if not event.is_reply:
...
@angelbot.on(angel_cmd(pattern="rar ?(.*)"))
@angelbot.on(sudo_cmd(pattern="rar ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@angelbot.on(angel_cmd(pattern="7z ?(.*)"))
@angelbot.on(sudo_cmd(pattern="7z ?(.*)", allow_sudo=True))
async def _(event): 
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
    ...
    if event.reply_to_msg_id:
        ...
        try:
            ...
            await bot.send_file(
                event.chat_id,
                directory_name + ".7z",
                caption="7z archived By angelBot",
                force_document=True,
                allow_cache=False,
                reply_to=event.message.id,
            )
...
@angelbot.on(angel_cmd(pattern="tar ?(.*)"))
@angelbot.on(sudo_cmd(pattern="tar ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
...
@angelbot.on(angel_cmd(pattern="unzip"))
@angelbot.on(sudo_cmd(pattern="unzip", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    mone = await event.edit("Processing ...")
...
@angelbot.on(angel_cmd(pattern="unrar"))
@angelbot.on(sudo_cmd(pattern="unrar", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    mone = await event.edit("Processing ...")
...
@angelbot.on(angel_cmd(pattern="untar"))
@angelbot.on(sudo_cmd(pattern="untar", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    mone = await event.edit("Processing ...")
