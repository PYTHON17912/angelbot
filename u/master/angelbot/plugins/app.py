...
@angelbot.on(angel_cmd(pattern="app (.*)"))
@angelbot.on(sudo_cmd(pattern="app (.*)", allow_sudo=True))
async def apk(event):
    if event.fwd_from:
        return
...
@angelbot.on(angel_cmd(pattern="appr (.*)"))
@angelbot.on(sudo_cmd(pattern="appr (.*)", allow_sudo=True))
...
@angelbot.on(angel_cmd(pattern="mods ?(.*)"))
@angelbot.on(sudo_cmd(pattern="mods ?(.*)", allow_sudo=True))
async def mod(event):
    if event.fwd_from:
        return
