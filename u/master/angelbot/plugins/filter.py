...
from . import *
from angelbot.sql.filter_sql import get_filter, add_filter, remove_filter, get_all_filters, remove_all_filters
...
@bot.on(angel_cmd(incoming=True))
...
@bot.on(angel_cmd(pattern=r"filter (.*)"))
...
@bot.on(angel_cmd(pattern="filters$"))
...
@bot.on(angel_cmd(pattern="rmallfilters$"))
