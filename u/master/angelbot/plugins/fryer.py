...
@bot.on(angel_cmd(pattern="frybot$"))
...
@bot.on(angel_cmd(pattern=r"fry(?: |$)(.*)", outgoing=True))
...
async def deepfry(img: Image) -> Image:
    ...
    # Overlay red and yellow onto main image and sharpen the angel out of it
