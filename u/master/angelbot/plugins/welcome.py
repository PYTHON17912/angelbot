...
from angelbot.sql.welcome_sql import get_current_welcome, add_welcome, rm_welcome, update_welcome
from . import *
...
@bot.on(angel_cmd(pattern="savewelcome(?: |$)(.*)"))
...
@bot.on(angel_cmd(pattern="cleanwelcome$"))
...
@bot.on(angel_cmd(pattern="showwelcome$"))
...
@bot.on(angel_cmd(pattern="welcome_note$"))
