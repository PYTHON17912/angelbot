...
@bot.on(angel_cmd(pattern=r"tweet(?: |$)(.*)"))
@bot.on(sudo_cmd(pattern="tweet(?: |$)(.*)", allow_sudo=True))
async def nope(angelkrish):
    angel = angelkrish.pattern_match.group(1)
    okvai = await eor(angelkrish, "Trying to tweet for you...")
    if not angel:
        if angelkrish.is_reply:
            (await angelkrish.get_reply_message()).message
        else:
            await eod(angelkrish, "I need some text to make a tweet🚶")
            return
    tweeter = await bot.inline_query("TwitterStatusBot", f"{(deEmojify(angel))}")
    await tweeter[0].click(
        angelkrish.chat_id,
        reply_to=angelkrish.reply_to_msg_id,
        silent=True if angelkrish.is_reply else False,
        hide_via=True,
    )
    await angelkrish.delete()


@bot.on(angel_cmd(pattern=r"trump(?: |$)(.*)"))
...
@bot.on(angel_cmd(pattern=r"modi(?: |$)(.*)"))
...
@bot.on(angel_cmd(pattern=r"mia(?: |$)(.*)"))
...
@bot.on(angel_cmd(pattern=r"dani(?: |$)(.*)"))
...
@bot.on(angel_cmd(pattern=r"pappu(?: |$)(.*)"))
...
@bot.on(angel_cmd(pattern=r"sunny(?: |$)(.*)"))
...
@bot.on(angel_cmd(pattern=r"johhny(?: |$)(.*)"))
...
@bot.on(angel_cmd(pattern=r"gandhi(?: |$)(.*)"))
...
@bot.on(angel_cmd(pattern=r"cmm(?: |$)(.*)"))
...
@bot.on(angel_cmd(pattern=r"kanna(?: |$)(.*)"))
