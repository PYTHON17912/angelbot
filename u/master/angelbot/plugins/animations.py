...
@bot.on(angel_cmd(pattern=r"boxs$", outgoing=True))
...
@bot.on(angel_cmd(pattern=r"rain$", outgoing=True))
...
@bot.on(angel_cmd(pattern=r"deploy$", outgoing=True))
...
async def _(event):
    ...
    animation_chars = [
        "**Heroku Connecting To Latest [Github Build](im_angel_girl00)**",
        f"**Build started by user** {angel_mention}",
        f"**Deploy** `535a74f0` **by user** **{angel_mention}**",
        ...
        "__INFO:angel:Logged in as 557667062__",
        "__INFO:angel:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
...
@bot.on(angel_cmd(pattern=r"dump$", outgoing=True))
...
@bot.on(angel_cmd(pattern=r"fleaveme$", outgoing=True))
...
@bot.on(angel_cmd(pattern=r"loveu$", outgoing=True))
...
@bot.on(angel_cmd(pattern=r"plane$", outgoing=True))
...
@bot.on(angel_cmd(pattern=r"police$", outgoing=True))
...
@bot.on(angel_cmd(pattern=f"hack$", outgoing=True))
...
@bot.on(angel_cmd(pattern=r"jio$", outgoing=True))
...
@bot.on(angel_cmd(pattern=r"solarsystem$", outgoing=True))
...
@bot.on(angel_cmd(pattern=f"nehi$", outgoing=True))
...
@bot.on(angel_cmd(pattern="phub$", outgoing=True))
...
@bot.on(angel_cmd(pattern=r"amore$", outgoing=True))
...
@bot.on(angel_cmd(pattern=r"sexy$", outgoing=True))
...
@bot.on(angel_cmd(pattern="istar$", outgoing=True))
@bot.on(sudo_cmd(pattern="istar$", allow_sudo=True))
async def ammastar(angelstar):
  
    if angelstar.fwd_from:
    ...
    await eor(angelstar, "I am A Star")
    ...
    for i in animation_ttl:
        ...
        await angelstar.edit(animation_chars[i % 11])
    
        
@bot.on(angel_cmd(pattern=r"lmoon", outgoing=True))
...
@bot.on(angel_cmd(pattern=r"city", outgoing=True))
...
@bot.on(angel_cmd(pattern=r"hii", outgoing=True))
...
@bot.on(angel_cmd(pattern=r"cheer", outgoing=True))
...
@bot.on(angel_cmd(pattern=r"getwell", outgoing=True))
...
@bot.on(angel_cmd(pattern="switch$", outgoing=True))
...
@bot.on(angel_cmd(pattern=r"sprinkle", outgoing=True))
...
@bot.on(angel_cmd(outgoing=True, pattern="kiler( (.*)|$)"))
...
async def _(event):
    ...
    event = await eor(event, f"**Ready Commando **__{angel_mention}....")
    animation_chars = [
        "Ｆｉｉｉｉｉｒｅ",
        f"__**Commando **__{angel_mention}          \n\n_/﹋\_\n (҂`_´)\n <,︻╦╤─ ҉ - \n _/﹋\_\n",
        f"__**Commando **__{angel_mention}          \n\n_/﹋\_\n (҂`_´)\n  <,︻╦╤─ ҉ - -\n _/﹋\_\n",
        f"__**Commando **__{angel_mention}          \n\n_/﹋\_\n (҂`_´)\n <,︻╦╤─ ҉ - - -\n _/﹋\_\n",
        f"__**Commando **__{angel_mention}          \n\n_/﹋\_\n (҂`_´)\n<,︻╦╤─ ҉ - -\n _/﹋\_\n",
        f"__**Commando **__{angel_mention}          \n\n_/﹋\_\n (҂`_´)\n <,︻╦╤─ ҉ - \n _/﹋\_\n",
...
@bot.on(angel_cmd(pattern="thinking$"))
...
@bot.on(angel_cmd(pattern=f"snake$", outgoing=True))
...
@bot.on(angel_cmd(pattern=f"human$", outgoing=True))
...
@bot.on(angel_cmd(pattern=f"mc$", outgoing=True))
...
@bot.on(angel_cmd(pattern="virus$"))
...
@bot.on(angel_cmd(pattern=r"repe$", outgoing=True))
...
@bot.on(angel_cmd(pattern=f"nikal$", outgoing=True))
...
@bot.on(angel_cmd(pattern=f"music$", outgoing=True))
...
async def _(event):
    ...
    animation_chars = [
        "⬤⬤⬤ 81% ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀`✖️`\n\n⠀⠀⠀⠀⠀[Music Player](t.me/angel_BOT_OFFICIAL)\n\n⠀⠀⠀⠀**Now Playing:shape of u**\n\n**00:00** ▱▱▱▱▱▱▱▱▱▱ **00:10**\n\n⠀⠀⠀⠀⠀`🔂` `⏮️` `⏪️` `▶️` `⏩️` `⏭️`\n\n**⠀Next Song:** __Alan Walker - Alone.__\n\n⠀⠀⠀⠀**⠀Device: I Fone XXX**",
        "⬤⬤⬤ 81% ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀`✖️`\n\n⠀⠀⠀⠀⠀[Music Player](t.me/angel_BOT_OFFICIAL)\n\n⠀⠀⠀⠀**Now Playing:shape of u**\n\n**00:01** ▰▱▱▱▱▱▱▱▱▱ **00:10**\n\n⠀⠀⠀⠀⠀`🔂` `⏮️` `⏪️` `⏸️` `⏩️` `⏭️`\n\n**⠀Next Song:** __Alan Walker - Alone.__\n\n⠀⠀⠀⠀**⠀Device: Ifone XXX**",
        "⬤⬤⬤ 81% ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀`✖️`\n\n⠀⠀⠀⠀⠀[Music Player](t.me/angel_BOT_OFFICIAL)\n\n⠀⠀⠀⠀**Now Playing:shape of u**\n\n**00:02** ▰▰▱▱▱▱▱▱▱▱ **00:10**\n\n⠀⠀⠀⠀⠀`🔂` `⏮️` `⏪️` `⏸️` `⏩️` `⏭️`\n\n**⠀Next Song:** __Alan Walker - Alone.__\n\n⠀⠀⠀⠀**⠀Device: Ifone XXX**",
        "⬤⬤⬤ 81% ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀`✖️`\n\n⠀⠀⠀⠀⠀[Music Player](t.me/angel_BOT_OFFICIAL)\n\n⠀⠀⠀⠀**Now Playing:shape of u**\n\n**00:03** ▰▰▰▱▱▱▱▱▱▱ **00:10**\n\n⠀⠀⠀⠀⠀`🔂` `⏮️` `⏪️` `⏸️` `⏩️` `⏭️`\n\n**⠀Next Song:** __Alan Walker - Alone.__\n\n⠀⠀⠀⠀**⠀Device: Ifone XXX**",
        "⬤⬤◯ 80% ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀`✖️`\n\n⠀⠀⠀⠀⠀[Music Player](t.me/angel_BOT_OFFICIAL)\n\n⠀⠀⠀⠀**Now Playing:shape of u**\n\n**00:04** ▰▰▰▰▱▱▱▱▱▱ **00:10**\n\n⠀⠀⠀⠀⠀`🔂` `⏮️` `⏪️` `⏸️` `⏩️` `⏭️`\n\n**⠀Next Song:** __Alan Walker - Alone.__\n\n⠀⠀⠀⠀**⠀Device: Ifone XXX**",
        "⬤⬤◯ 80% ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀`✖️`\n\n⠀⠀⠀⠀⠀[Music Player](t.me/angel_BOT_OFFICIAL)\n\n⠀⠀⠀⠀**Now Playing:shape of u**\n\n**00:05** ▰▰▰▰▱▱▱▱▱▱ **00:10**\n\n⠀⠀⠀⠀⠀`🔂` `⏮️` `⏪️` `⏸️` `⏩️` `⏭️`\n\n**⠀Next Song:** __Alan Walker - Alone.__\n\n⠀⠀⠀⠀**⠀Device: Ifone XXX**",
        "⬤⬤◯ 80% ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀`✖️`\n\n⠀⠀⠀⠀⠀[Musi  Player](t.me/angel_BOT_OFFICIAL)\n\n⠀⠀⠀⠀**Now Playing:shape of u**\n\n**00:06** ▰▰▰▰▰▰▱▱▱▱ **00:10**\n\n⠀⠀⠀⠀⠀`🔂` `⏮️` `⏪️` `⏸️` `⏩️` `⏭️`\n\n**⠀Next Song:** __Alan Walker - Alone.__\n\n⠀⠀⠀⠀**⠀Device: Ifone XXX**",
        "⬤⬤◯ 80% ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀`✖️`\n\n⠀⠀⠀⠀⠀[Music Player](t.me/angel_BOT_OFFICIAL)\n\n⠀⠀⠀⠀**Now Playing:shape of u**\n\n**00:07** ▰▰▰▰▰▰▰▱▱▱ **00:10**\n\n⠀⠀⠀⠀⠀`🔂` `⏮️` `⏪️` `⏸️` `⏩️` `⏭️`\n\n**⠀Next Song:** __Alan Walker - Alone.__\n\n⠀⠀⠀⠀**⠀Device: Ifone XXX**",
        "⬤⬤◯ 80% ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀`✖️`\n\n⠀⠀⠀⠀⠀[Music Player](t.me/angel_BOT_OFFICIAL)\n\n⠀⠀⠀⠀**Now Playing:shape of u**\n\n**00:08** ▰▰▰▰▰▰▰▰▱▱ **00:10**\n\n⠀⠀⠀⠀⠀`🔂` `⏮️` `⏪️` `⏸️` `⏩️` `⏭️`\n\n**⠀Next Song:** __Alan Walker - Alone.__\n\n⠀⠀⠀⠀**⠀Device: Ifone XXX**",
        "⬤⬤◯ 80% ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀`✖️`\n\n⠀⠀⠀⠀⠀[Music Player](t.me/angel_BOT_OFFICIAL)\n\n⠀⠀⠀⠀**Now Playing:shape of u**\n\n**00:09** ▰▰▰▰▰▰▰▰▰▱ **00:10**\n\n⠀⠀⠀⠀⠀`🔂` `⏮️` `⏪️` `⏸️` `⏩️` `⏭️`\n\n**⠀Next Song:** __Alan Walker - Alone.__\n\n⠀⠀⠀⠀**⠀Device: Ifone XXX**",
        "⬤⬤◯ 80% ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀`✖️`\n\n⠀⠀⠀⠀⠀[Music Player](t.me/angel_BOT_OFFICIAL)\n\n⠀⠀⠀⠀**Now Playing:shape of u**\n\n**00:10** ▰▰▰▰▰▰▰▰▰▰ **00:10**\n\n⠀⠀⠀⠀⠀`🔂` `⏮️` `⏪️` `⏺️` `⏩️` `⏭️`\n\n**⠀Next Song:** __Alan Walker - Alone.__\n\n⠀⠀⠀⠀**⠀Device: Ifone XXX**",
...
@bot.on(angel_cmd(pattern=f"squ$", outgoing=True))
...
@bot.on(angel_cmd(pattern=r"padmin ?(.*)", outgoing=True))
...
@bot.on(angel_cmd(pattern=r"hack$", outgoing=True))
