...
@angelbot.on(angel_cmd(pattern="anilist (.*)"))
@angelbot.on(sudo_cmd(pattern="anilist (.*)", allow_sudo=True))
...
@angelbot.on(angel_cmd(pattern="anime(?: |$)(.*)"))
@angelbot.on(sudo_cmd(pattern="anime(?: |$)(.*)", allow_sudo=True))
async def nope(d3vl_):
    angel = d3vl_.pattern_match.group(1)
    if not angel:
        if d3vl_.is_reply:
    ...
    troll = await bot.inline_query("AniFluidbot", f".anime {(deEmojify(angel))}")
...
@angelbot.on(angel_cmd(pattern="manga(?: |$)(.*)"))
@angelbot.on(sudo_cmd(pattern="manga(?: |$)(.*)", allow_sudo=True))
async def nope(d3vl_):
    angel = d3vl_.pattern_match.group(1)
    if not angel:
        if d3vl_.is_reply:
    ...
    troll = await bot.inline_query("AniFluidbot", f".manga {(deEmojify(angel))}")
...
@angelbot.on(angel_cmd(pattern="character(?: |$)(.*)"))
@angelbot.on(sudo_cmd(pattern="character(?: |$)(.*)", allow_sudo=True))
async def nope(d3vl_):
    angel = d3vl_.pattern_match.group(1)
    if not angel:
        if d3vl_.is_reply:
    ...
    troll = await bot.inline_query("AniFluidbot", f".character {(deEmojify(angel))}")
