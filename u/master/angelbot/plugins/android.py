...
@angelbot.on(angel_cmd(pattern=r"magisk"))
@angelbot.on(sudo_cmd(pattern=r"magisk", allow_sudo=True))
async def _(magisk):
    if magisk.fwd_from:
        return
...
@angelbot.on(angel_cmd(outgoing=True, pattern=r"device(?: |$)(\S*)"))
@angelbot.on(sudo_cmd(pattern=r"device(?: |$)(\S*)", allow_sudo=True))
...
@angelbot.on(angel_cmd(outgoing=True, pattern=r"codename(?: |)([\S]*)(?: |)([\s\S]*)"))
@angelbot.on(sudo_cmd(pattern=r"codename(?: |)([\S]*)(?: |)([\s\S]*)", allow_sudo=True))
...
@angelbot.on(angel_cmd(outgoing=True, pattern=r"specs(?: |)([\S]*)(?: |)([\s\S]*)"))
@angelbot.on(sudo_cmd(pattern=r"specs(?: |)([\S]*)(?: |)([\s\S]*)", allow_sudo=True))
...
@angelbot.on(angel_cmd(outgoing=True, pattern=r"twrp(?: |$)(\S*)"))
@angelbot.on(sudo_cmd(pattern=r"twrp(?: |$)(\S*)", allow_sudo=True))
