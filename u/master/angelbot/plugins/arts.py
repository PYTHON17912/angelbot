...
@bot.on(angel_cmd(pattern="carry (.*)"))
@bot.on(sudo_cmd(pattern="carry (.*)", allow_sudo=True))
async def angelkrish(carry):
    if carry.fwd_from:
        return
...
@bot.on(angel_cmd(pattern="sthink (.*)"))
@bot.on(sudo_cmd(pattern="sthink (.*)", allow_sudo=True))
async def angelkrish(think):
    if think.fwd_from:
        return
...
@bot.on(angel_cmd(pattern="sfrog (.*)"))
@bot.on(sudo_cmd(pattern="sfrog (.*)", allow_sudo=True))
async def angelkrish(frogsay):
    if frogsay.fwd_from:
        return
...
@bot.on(angel_cmd(pattern="sdead (.*)"))
@bot.on(sudo_cmd(pattern="sdead (.*)", allow_sudo=True))
async def angelkrish(deadfrog):
...
@bot.on(angel_cmd(pattern="strump (.*)"))
@bot.on(sudo_cmd(pattern="strump (.*)", allow_sudo=True))
async def angelkrish(trumpsay):
...
@bot.on(angel_cmd(pattern="schina (.*)"))
@bot.on(sudo_cmd(pattern="schina (.*)", allow_sudo=True))
async def angelkrish(ckmkb):
    if ckmkb.fwd_from:
        return
...
@bot.on(angel_cmd(pattern=r"sshit$"))
@bot.on(sudo_cmd(pattern="sshit$", allow_sudo=True))
async def angelkrish(shit):
    if shit.fwd_from:
        return
    await edit_or_reply(shit, A)


@bot.on(angel_cmd(pattern=r"elove$"))
...
@bot.on(angel_cmd(pattern=r"monster$"))
...
@bot.on(angel_cmd(pattern=r"pig$"))
...
@bot.on(angel_cmd(pattern=r"gun$"))
...
@bot.on(angel_cmd(pattern=r"dog$"))
...
@bot.on(angel_cmd(pattern=r"hello$"))
...
@bot.on(angel_cmd(pattern=r"hmf$"))
...
@bot.on(angel_cmd(pattern=r"couple$"))
...
@bot.on(angel_cmd(pattern=r"sup$"))
...
@bot.on(angel_cmd(pattern=r"india$"))
...
@bot.on(angel_cmd(pattern=r"snk$"))
...
@bot.on(angel_cmd(pattern=r"bye$"))
...
@bot.on(angel_cmd(pattern=r"shitos$"))
...
@bot.on(angel_cmd(pattern=r"dislike$"))
