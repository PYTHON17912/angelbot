...
@bot.on(angel_cmd(pattern="pat ?(.*)", outgoing=True))
...
@bot.on(angel_cmd(pattern="joined$", outgoing=True))
...
@bot.on(angel_cmd(pattern="pay$", outgoing=True))
...
@bot.on(angel_cmd(pattern="climb$", outgoing=True))
...
@bot.on(angel_cmd(pattern="aag$", outgoing=True))
...
@bot.on(angel_cmd(pattern="push$", outgoing=True))
...
@bot.on(angel_cmd(pattern="work$", outgoing=True))
...
@bot.on(angel_cmd(pattern="suckit$", outgoing=True))
...
@bot.on(angel_cmd(pattern="ohh$", outgoing=True))
...
@bot.on(angel_cmd(pattern="lovestory$", outgoing=True))
...
@bot.on(angel_cmd(pattern="bf$", outgoing=True))
...
@bot.on(angel_cmd(pattern="session$", outgoing=True))
...
@bot.on(angel_cmd(pattern="ftext ?(.*)"))
...
@bot.on(angel_cmd(pattern="cat$"))
@bot.on(sudo_cmd(pattern="cat$", allow_sudo=True))
async def hmm(angel):
    if angel.fwd_from:
        return
    reactcat = nekos.textcat()
    await eor(angel, reactcat)


@bot.on(angel_cmd(pattern="why$"))
@bot.on(sudo_cmd(pattern="why$", allow_sudo=True))
async def hmm(angel):
    if angel.fwd_from:
        return
    whyangel = nekos.why()
    await eor(angel, whyangel)


@bot.on(angel_cmd(pattern="fact$"))
@bot.on(sudo_cmd(pattern="fact$", allow_sudo=True))
async def hmm(angel):
    if angel.fwd_from:
        return
    factangel = nekos.fact()
    await eor(angel, factangel)
