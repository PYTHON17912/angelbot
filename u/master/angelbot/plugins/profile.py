...
@bot.on(angel_cmd(pattern="offline$", outgoing=True)) 
async def _(event):
    if event.fwd_from:
        return
    user_it = "me"
...
@bot.on(angel_cmd(pattern="online$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    user_it = "me"
...
@bot.on(angel_cmd(pattern="pname (.*)"))
async def _(event):
    if event.fwd_from:
        return
...
@bot.on(angel_cmd(outgoing=True, pattern="username (.*)"))
...
@bot.on(angel_cmd(outgoing=True, pattern="count$"))
...
@bot.on(angel_cmd(outgoing=True, pattern=r"delpfp"))
...
@bot.on(angel_cmd(pattern="myusernames$"))
async def _(event):
    if event.fwd_from:
        return
