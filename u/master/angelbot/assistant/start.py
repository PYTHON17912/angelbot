...
from angelbot.random_strings import *
from angelbot.version import __angel__
from telethon import version
from angelbot.plugins._inhelp import *
from angelbot import bot
from angelbot.sql.blacklist_assistant import (
    add_nibba_in_db,
    is_he_added,
    removenibba,
)
from angelbot.sql.botusers import add_me_in_db, his_userid
from angelbot.sql.idadder import (
    add_usersid_in_db,
    already_added,
    get_all_users,
)
    ...
    if event.sender_id == bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                ...
                [custom.Button.inline("MY GROUP AND CHANNEL", data="alive")],
                [
                    Button.url(
        ...
        await tgbot.send_message(
            ...
            buttons=[
                ...
                [Button.url("𝚂𝚄𝙿𝙿𝙾𝚁𝚃 ❓", "https://t.me/angel_BOT_SUPPORT")],
             ],
        )
    ...
    if event.query.user_id is not bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                ...
                [Button.url("Need Help ❓", "https://t.me/angel_BOT_SUPPORT")],
                [Button.url("🔰 𝚁𝙴𝙿𝙾 ", "https://github.com/TEAM-angel/angelBot")],
            ],
        )
