...
class Config(object):
    ...
    ALIVE_MSG = os.environ.get("ALIVE_MSG", "⚡ ℓεgεη∂αяү αғ ᴀɴɢᴇʟʙᴏᴛ  ⚡")
    ...
    if AUTH_TOKEN_DATA != None:
        ...
        t_file.close()
    BIO_MSG = os.environ.get("BIO_MSG", "༆ʟᴇɢᴇɴᴅʀʏ ᴀғ ᴀɴɢᴇʟʙᴏᴛ༆")
    ...
    MY_CHANNEL = os.environ.get("YOUR_CHANNEL", "im_angel_girl00")
    MY_GROUP = os.environ.get("YOUR_GROUP", "im_angel_girl00")
    ...
    angelBOT_SESSION = os.environ.get("angelBOT_SESSION", None)
    SUDO_HANDLER = os.environ.get("SUDO_HANDLER", r"\.")
    SUDO_USERS = set(int(x) for x in os.environ.get("SUDO_USERS", "").split())
    TAG_LOGGER = os.environ.get("TAG_LOGGER", None)
    if TAG_LOGGER: 
        TAG_LOGGER = int(TAG_LOGGER)
    TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "angelBot")
    TEMP_DIR = os.environ.get("TEMP_DIR", None)
    TMP_DOWNLOAD_DIRECTORY = os.environ.get("TMP_DOWNLOAD_DIRECTORY", "./DOWNLOADS/")
    TZ = os.environ.get("TZ", "Asia/Kolkata")
    UPSTREAM_REPO = os.environ.get("UPSTREAM_REPO", "https://github.com/TEAM-angel/angelBot")
