...
my_channel = Config.MY_CHANNEL or "im_angel_girl00"
my_group = Config.MY_GROUP or "im_angel_girl00"
if "@" in my_channel:
    my_channel = my_channel.replace("@", "")
if "@" in my_group:
    my_group = my_group.replace("@", "")

chnl_link = "https://t.me/im_angel_girl00"
d3vil_channel = f"[тнε ᴀɴɢᴇʟʙᴏᴛ]({chnl_link})"
grp_link = "https://t.me/im_angel_girl00"
d3vil_grp = f"[тнε ᴀɴɢᴇʟʙᴏᴛ]({grp_link})"
