...
if okvai == "y" or "yes":
    ...
    with TelegramClient(StringSession(), APP_ID, API_HASH) as client:
        ...
        client.send_message("me", "Above is your #_SESSION \nPaste this string in Heroku Var.\n\n[Team ᴀɴɢᴇʟ](t.me/im_angel_girl00)")

else:
    print("Your D3vil string session genreted successfully. Join for query im_angel_girl00")
